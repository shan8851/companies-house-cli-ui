    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
        ...
        >
          ...
          <CodeBlock code="clawhub install companies-house-cli" />
          ...
          <a
            href="https://clawhub.ai/shan8851/companies-house-cli"
            target="_blank"
            rel="noopener noreferrer"
        ...
        >
          ...
          <CodeBlock code="npx skills add shan8851/agent-skills --skill companies-house-cli" />
